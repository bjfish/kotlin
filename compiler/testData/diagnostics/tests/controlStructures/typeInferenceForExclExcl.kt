...
fun test11() {
    ...
    exclExcl(A.foo()) checkType { <!NI;UNRESOLVED_REFERENCE_WRONG_RECEIVER!><!NI;DEBUG_INFO_UNRESOLVED_WITH_TARGET!><!UNRESOLVED_REFERENCE_WRONG_RECEIVER!><!DEBUG_INFO_UNRESOLVED_WITH_TARGET!>_<!><!><!><!><String?>() }
