...
fun foo() {
    if (<!NI;UNRESOLVED_REFERENCE!><!UNRESOLVED_REFERENCE!>i<!><!> <!NI;RESULT_TYPE_MISMATCH!><!NI;DEBUG_INFO_ELEMENT_WITH_ERROR_TYPE!><!RESULT_TYPE_MISMATCH!><!DEBUG_INFO_ELEMENT_WITH_ERROR_TYPE!>==<!><!><!><!> 3) <!NI;UNRESOLVED_REFERENCE!><!UNRESOLVED_REFERENCE!>f<!><!>()
}
