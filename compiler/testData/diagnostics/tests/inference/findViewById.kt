...
val yCast = Test().findViewById(0) <!NI;UNCHECKED_CAST!><!UNCHECKED_CAST!>as Y<String><!><!>
...
class TestChild : Test() {
    ...
    val yCast = findViewById(0) <!NI;UNCHECKED_CAST!><!UNCHECKED_CAST!>as Y<String><!><!>
}
...
fun test(t: Test) {
    ...
    val yCast = t.findViewById(0) <!NI;UNCHECKED_CAST!><!UNCHECKED_CAST!>as Y<String><!><!>
}
